...
public class RSAKeyPairGenerator {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
        ...
        keyPairGenerator.writeToFile("C:\\Users\\pc1\\publicKey", keyPairGenerator.getPublicKey().getEncoded());
        keyPairGenerator.writeToFile("C:\\Users\\pc1\\privateKey", keyPairGenerator.getPrivateKey().getEncoded());
